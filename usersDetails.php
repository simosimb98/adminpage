...
?>
  <!-- Begin Page Content -->
                ...
                <h1 class="h3 mb-2 text-gray-800">Verified Users</h1>
                        <a href="#manualUsersShippingDetails" class="btn btn-primary" data-toggle="modal"><i class="fas fa-question-circle">
                        </i> <span>Help</span></a>
                    </div>
...
<!-- Manual Modal HTML -->
   <div id="manualUsersShippingDetails" class="modal fade">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">              
                   <?php
                      include_once 'manuals/manualUsersDetails.html';         
                   ?>  
                    <div class="modal-footer">
